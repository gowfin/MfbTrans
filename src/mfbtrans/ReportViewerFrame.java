...
public class ReportViewerFrame extends JFrame {
	...
	public ReportViewerFrame(ReportClientDocument reportClientDoc) throws Exception {
		...
		this.setTitle("Gowfin-Crystal Report Java Viewer");
                //set parameter for database connection
                String DBUSERNAME = "sa";
            String DBPASSWORD = "Admin123Server";
            String SERVERNAME = "OMFBICT\\SQLEXPRESS";
            String PORT = "1433";
            String DATABASE_NAME = "Bankdatabase"; // SID or Instance
           //String URL="jdbc:sqlserver://"+SERVERNAME+"\\SQLEXPRESS:1433;databaseName=BankDatabase";
           ...
           // String URI = "!oracle.jdbc.driver.OracleDriver!jdbc:oracle:thin:{userid}/{password}@" + SERVERNAME + ":" + PORT + "/" + DATABASE_NAME;  //1521/ or :1521
            ...
            propertyBag.put("Connection URL", URL);
           ...
           // reportClientDoc.getDatabaseController().setTableLocation(table, table);

            //reportClientDoc.getDataDefController().getParameterFieldController().setCurrentValue("", "Groupid", 14);
		...
		//reportViewer.printView();
                reportViewer.setZoomFactor(50);
                //reportViewer.setReportParameter("Groupid");
                //reportViewer.setReportParameter("loanofficer");
		//Display the frame.
