...
public class JCalendar extends JPanel implements PropertyChangeListener {
	...
	public JCalendar(Date date, Locale locale, boolean monthSpinner,
		...
		setName("Emma JCalendar");//frame title
		...
		monthChooser = new com.toedter.calendar.JMonthChooser(monthSpinner);
		...
		dayChooser = new com.toedter.calendar.JDayChooser(weekOfYearVisible);
		...
		todayButton = new JButton();
                todayButton.setActionCommand("Emma");
		todayButton.addActionListener(new ActionListener() {

			public void actionPerformed(ActionEvent e) {
				setDate(new Date());
                                JOptionPane.showMessageDialog(dayChooser, "Ok");
	...
	public static void main(String[] s) {
		JFrame frame = new JFrame("EmmyCalendar");

		JCalendar jcalendar = new JCalendar();//set title here
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (calendar != null) {
			...
			if (evt.getPropertyName().equals("day")) {
				...
				setCalendar(c, false);
                int YY=yearChooser.getValue();
                int mm=monthChooser.getMonth()+1;
                int dd=dayChooser.getDay();
                ///// //////////Utilizing the date
           Schedule sch = new  Schedule () ; /////initializing the frame to use date
              String  Date =YY+"-"+mm+"-"+dd;
              sch.jTextFielddate.setText(Date);
